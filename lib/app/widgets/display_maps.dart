...
class GeoMapPage extends StatefulWidget {
  const GeoMapPage({Key? key, required this.latitude, required this.longitude}) : super(key: key);
  ...
  Future<void> getLocation() async {
    ...
    if (!hasPermisson) {
          ...
          builder: (context) {
            return AlertDialog(
              ...
              content: SingleChildScrollView(
                child: ListBody(
                  children: const [
                    Text("Tanpa izin penggunaan lokasi aplikasi ini tidak dapat digunakan dengan baik. Apa anda yakin menolak izin pengaktifan lokasi?", style: TextStyle(fontSize: 18.0)),
                  ],
                ),
              ),
              actions: [
      ...
      try {
        ...
        //         content: Text('Fake GPS terdeteksi. Mohon non aktifkan fitur Fake GPS Anda'),
        //       ));
        //       TrustLocation.stop();
        //       return;
        //     }
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Column(children: [
                        ...
                        isLoading ? const Text("Sedang mencari lokasi ...") : Text("Lokasi anda adalah \n: Lat : $_latitude \nLong : $_longitude"),
                        Text("Alamat : \n" + _address.toString(), textAlign: TextAlign.center),
                        ...
                        Visibility(
                          ...
                          child: ElevatedButton.icon(
                              ...
                              label: const Padding(
                                ...
                                child: Text("Refres Lokasi", style: TextStyle(fontSize: 16)),
                              )),
                        )
                      ]),
                    ),
