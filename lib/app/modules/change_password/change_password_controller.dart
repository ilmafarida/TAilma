  ...
  submit() async {
    try {
      if (passC.text.isEmpty || passNewC.text.isEmpty) {
        ScaffoldMessenger.of(Get.context!).showSnackBar(SnackBar(content: Text("Field harus diisi")));
      ...
      if (e.code == 'weak-password') {
        ...
        ScaffoldMessenger.of(Get.context!).showSnackBar(SnackBar(content: Text("User harus login terlebih dahulu")));
      }
    } catch (e) {
      ScaffoldMessenger.of(Get.context!).showSnackBar(SnackBar(content: Text("Kesalahan server")));
    }
  }
}
